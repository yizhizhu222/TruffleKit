...
2. Repository name 填 `truffle`
3. Description 填 `TruffleKit CLI — AI 项目确定性安全审查工具`
4. 选 Public
...
```bash
git remote add origin https://github.com/你的用户名/truffle.git
git branch -M main
...
```bash
git remote add origin git@github.com:你的用户名/truffle.git
git push -u origin main
```
